...
| TC-02 | Armed motion warning | `101 310` | `mode=night`, `level=warn` | `line.kind=warn` | `System Event` |
| TC-03 | Armed tamper escalation | `101 302` | `mode=night`, `level=alert` | `line.kind=alert` | `Security Alert` |
...
| TC-08 | Mode transition acknowledgement | `100 101 100` | `mode=disarm`, `level=off` | `line.kind=command_ack` | `System Event` |
